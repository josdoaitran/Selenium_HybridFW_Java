...
public class ExecuteTestcase {
    ...
    public static void execute_TestCase(String TestSuite, String TestReport) throws Exception {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        File source = new File(TestSuite);
        File dest = new File(TestReport);
        FileUtils.copyFile(source,dest);
        //ReadWriteExcel.setExcelFile(Constants.Path_TestData);   //This is to start the Log4j logging in the test case
        ReadWriteExcel.setExcelFile(TestReport);
        //ReadWriteExcel.closeExcelfile(TestSuite);
        new ExecuteTestcase();
        ...
        /*ReadWriteExcel.saveExcelFile(TestReport);
        ReadWriteExcel.closeExcelfile(TestSuite);*/
    }
